        ...
        <>
            ...
            <div className="multiplayer-container">
                <div className="mp-settings-container">
                    <div onClick={onSettingsClick} className="mp-settings-button">
                        Game Settings
                    </div>
                </div>
                <div className="mp-start-container">
                    <div onClick={onStartClick} className="mp-start-button">
                        Start Game
                    </div>
                </div>
                <div className="mp-players-container">
                ...
                <div className="mp-room-code-container">
                    <div className="mp-room-code">Room Code: {roomCode}</div>
                </div>
                {isModalOpen && (
                    <div className="mp-settings-modal">
                        <div className="mp-settings-modal-content">
                            <div className="mp-settings-modal-close" onClick={onExitClick}>
                                Close Settings
                            </div>
                            <div className="mp-settings-modal-minLetters">
                                <div className="mp-settings-modal-minLetters-title">Min Letters</div>
                                <input
                                    className="mp-settings-modal-minLetters-slider"
                                    type="range"
                                    id="minLetters"
                                    min="3"
                                    max="6"
                                ...
                                />
                                <div className="mp-settings-modal-minLetters-value">{minLetters}</div> 
                            </div>
                            <div className="mp-settings-modal-time">
                                <div className="mp-settings-modal-time-title">
                                    Time (seconds)
                                </div>
                                <div className="mp-settings-modal-time-buttons">
                                <div
                                    onClick={on30Click}
                            ...
                            <div className="mp-settings-modal-hideLetter">
                                Hide Next Letter
                                <label className="mp-switch">
                                    <input type="checkbox" onClick={onHideLetterClick} />
                                    <span className="mp-slider round"></span>
                                </label>
                            </div>
                            <div className="mp-settings-modal-hardMode">
                                Hard Mode
                                <label className="mp-switch">
