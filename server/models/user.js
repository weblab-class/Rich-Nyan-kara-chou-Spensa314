...
const userSchema = new mongoose.Schema({
  ...
  savedThemes: {
    ...
    default: [
      ...
      {
        name: "Futuristic",
        cssVariables: `{"--white":"#fff","--light--beige":"#E6D6FF","--dull--beige":"#D4C2ED","--beige":"#CFB8FA","--off--beige":"#BEA6F2","--dark--beige":"#9C7EE1","--off--dark--beige":"#8A6DD2","--light--beige--glass":"rgba(203, 178, 255, 0.353)","--beige--glass":"rgba(130, 137, 202, 0.874)","--brown--glass":"rgba(73, 82, 140, 0.708)","--light--brown":"#6889B0","--off--light--brown":"#5979B1","--dark--light--brown":"#5575A8","--brown":"#39527F","--beige--shadow":"rgb(87, 98, 179)","--off--brown":"#2F406E","--dull--dark--brown":"#2C3C5E","--dark--brown":"#0F234A","--dark--brown--glass":"#0F234Acf","--off--dark--brown":"#0C1E41"}`
      },
      {
        name: "Lilac Rain",
