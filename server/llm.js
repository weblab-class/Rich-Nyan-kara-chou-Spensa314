...
async function sendPromptToClaude(theme) {
  ...
  try {
    const prompt = `
Hello, Claude! I want you to be a color palette generator. Can you keep the same names but change the colors to match ${theme}? If the theme has or names multiple colors, make sure to have an even split of each color. Print only the same names and their values.
